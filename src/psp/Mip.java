...
public class Mip {
	...
	public static IloNumVar[][] puissanceTurbine;
	public static IloNumVar[][] puissancePompe;

	public static IloNumVar[][] hauteurChute;

	public static IloNumVar[][] coutAtoP;
	public static IloNumVar[][] coutPtoA;
	public static IloNumVar[][] coutAtoT;
	public static IloNumVar[][] coutTtoA;
	IloNumExpr obj;
		...
		if (model.solve()) {
			...
			for (int turbineCourante = 0; turbineCourante < instance.getTPs().length; turbineCourante++) {
				...
				for (int heureCourante = 0; heureCourante < instance.getCout().length; heureCourante++) {
					...
					System.out.println(
							" - puissanceTurbine" + model.getValue(puissanceTurbine[turbineCourante][heureCourante]));
					System.out.println(
							" - puissancePompe" + model.getValue(puissancePompe[turbineCourante][heureCourante]));
					System.out
							.println(" - hauteurChute" + model.getValue(hauteurChute[turbineCourante][heureCourante]));
					System.out.println("----------------------------------------------------------------");
				}
			...
			for (int turbineCourante = 0; turbineCourante < instance.getTPs().length; turbineCourante++) {
				...
				for (int heureCourante = 0; heureCourante < instance.getCout().length; heureCourante++) {
					...
					// if
					// (model.getValue(stateAtoP[turbineCourante][heureCourante])
					// == 1.0) {
					// System.out.println(" - passage de A ver P");
					// }
					// if
					// (model.getValue(statePtoA[turbineCourante][heureCourante])
					// == 1.0) {
					// System.out.println(" - passage de P ver A");
					// }
					// if
					// (model.getValue(stateAtoT[turbineCourante][heureCourante])
					// == 1.0) {
					// System.out.println(" - passage de A ver T");
					// }
					// if
					// (model.getValue(stateTtoA[turbineCourante][heureCourante])
					// == 1.0) {
	...
	private void initVariables() throws IloException {
		...
		for (int i = 0; i < instance.getTPs().length; i++) {
			for (int j = 0; j < instance.getCout().length; j++) {
				...
				hauteurChute[i][j] = model.numVar(-instance.getInf().getHauteur() + instance.getDelta_H(),
						instance.getSup().getHauteur() + instance.getDelta_H(), "hauteurChute" + i + "_" + j);
			}
		}
	...
	private void initConstraintesPuissance() throws IloException {
		for (int turbineCourante = 0; turbineCourante < instance.getTPs().length; turbineCourante++) {
			for (int heureCourante = 0; heureCourante < instance.getCout().length; heureCourante++) {
				model.addLe(
						model.sum(modePompe[turbineCourante][heureCourante],
								modeTurbine[turbineCourante][heureCourante]),
						1, "contrainteMode" + turbineCourante + "_" + heureCourante);
				model.addLe(puissanceTurbine[turbineCourante][heureCourante],
						model.prod(modeTurbine[turbineCourante][heureCourante],
								instance.getTPs()[turbineCourante].getP_T_max()),
						"contraintePuissanceTurbine" + turbineCourante + "_" + heureCourante);
				model.addGe(puissanceTurbine[turbineCourante][heureCourante],
						model.prod(modeTurbine[turbineCourante][heureCourante],
								instance.getTPs()[turbineCourante].getP_T_min()),
						"contraintePuissanceTurbine" + turbineCourante + "_" + heureCourante);
				model.addLe(puissancePompe[turbineCourante][heureCourante],
						model.prod(modePompe[turbineCourante][heureCourante],
								instance.getTPs()[turbineCourante].getP_P_min()),
						"contraintePuissancePompe" + turbineCourante + "_" + heureCourante);
				model.addGe(puissancePompe[turbineCourante][heureCourante],
						model.prod(modePompe[turbineCourante][heureCourante],
								instance.getTPs()[turbineCourante].getP_P_max()),
						"contraintePuissancePompe" + turbineCourante + "_" + heureCourante);
			}
		}
	}
	...
	private void initContraintesReservoir() throws IloException {
		for (int turbineCourante = 0; turbineCourante < instance.getTPs().length; turbineCourante++) {
			model.addEq(hauteurChute[turbineCourante][0],
					instance.getSup().getH_0() - instance.getInf().getH_0() + instance.getDelta_H());
			model.addEq(modePompe[turbineCourante][0], modePompeInit);
			model.addEq(modeTurbine[turbineCourante][0], modeTurbineInit);
			for (int heureCourante = 0; heureCourante < instance.getCout().length - 1; heureCourante++) {
				...
				IloNumExpr expr = model.prod(puissanceTurbine[turbineCourante][heureCourante + 1],
						coef / instance.getTPs()[turbineCourante].getAlpha_P());
				expr = model.sum(expr, model.prod(puissancePompe[turbineCourante][heureCourante + 1],
						coef / instance.getTPs()[turbineCourante].getAlpha_T()));
				model.addEq(model.diff(hauteurChute[turbineCourante][heureCourante],
						hauteurChute[turbineCourante][heureCourante + 1]), expr);
			}
		}
	}
	...
	private void initObjective() throws IloException {
		...
		for (int turbineCourante = 0; turbineCourante < instance.getTPs().length; turbineCourante++) {
			for (int heureCourante = 0; heureCourante < instance.getCout().length; heureCourante++) {
				IloNumExpr coutPuissance = model.prod(instance.getCout()[heureCourante],
						model.sum(puissanceTurbine[turbineCourante][heureCourante],
	...
	public Integer getMODE_POMPE_INIT() {
		return modePompeInit;
	}

	public void setMODE_POMPE_INIT(int mODE_POMPE_INIT) {
		modePompeInit = mODE_POMPE_INIT;
	}

	public Integer getMODE_TURBINE_INIT() {
		return modeTurbineInit;
	}

	public void setMODE_TURBINE_INIT(int mODE_TURBINE_INIT) {
